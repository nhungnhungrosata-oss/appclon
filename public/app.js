...
function showAudio(rec){S.latestAudio=rec;$('#audio-output').hidden=false;$('#tts-preview').src=rec.remoteUrl||blobUrl(rec);$('#audio-duration').textContent=rec.remoteUrl?'Link Ibee tạm thời':clock(rec.duration)}
